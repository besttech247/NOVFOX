...
export function Sparkline({ data, vwap, width = 110, height = 34, positive }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.fillStyle = color
    ctx.fill()
  }, [data, vwap, width, height, positive])

  return <canvas ref={ref} style={{ width, height }} className="block" dir="ltr" />
}
